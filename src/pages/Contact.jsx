                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full border px-4 py-3 rounded focus:outline-none focus:border-black"
                      placeholder=""
                    />
                  </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">General: info@styleshop.com</p>
                      <p className="text-gray-600">Support: support@styleshop.com</p>
                      <p className="text-gray-600">Sales: sales@styleshop.com</p>
                    </div>
                  </div>
